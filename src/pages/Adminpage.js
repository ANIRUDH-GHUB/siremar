          ...
          <main>
            <div class="container-fluid px-4">
                ...
                <div class="col-xl-3 col-md-6">
                  <div class="card bg-primary text-white mb-4">
                    <div class="card-body">
                      ...
                      <small style={{ fontSize: "12px", paddingLeft: "100px" }}>20000</small>
                    </div>
                ...
                <div class="col-xl-3 col-md-6">
                  <div class="card bg-warning text-white mb-4">
                    <div class="card-body">
                      ...
                      <small style={{ fontSize: "12px", paddingLeft: "100px" }}>154000</small>
                    </div>
                ...
                <div class="col-xl-3 col-md-6">
                  <div class="card bg-success text-white mb-4">
                    <div class="card-body">
                      ...
                      <small style={{ fontSize: "12px", paddingLeft: "100px" }}>1560</small>
                    </div>
                ...
                <div class="col-xl-3 col-md-6">
                  <div class="card bg-danger text-white mb-4">
                    <div class="card-body">
                      ...
                      <small style={{ fontSize: "12px", paddingLeft: "100px" }}>9</small>
                    </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-6 mt-3">
                  <h3>list of <span> counties  </span> </h3>
                  <table class="table  table-bordered table-striped">
                    <thead>
                      <tr>
                        <th scope="col">#</th>
